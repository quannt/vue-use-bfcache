...
```sh
# npm
npm install vue-use-bfcache

# yarn
yarn add vue-use-bfcache

# pnpm
pnpm install vue-use-bfcache

# bun
bun install vue-use-bfcache
```
...
```js
// ESM
import {} from "vue-use-bfcache";

// CommonJS
const {} = require("vue-use-bfcache");
```
